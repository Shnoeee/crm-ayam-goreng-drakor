...
<div class="col-md-12 mt-5">
    <div class="card">
        <div class="header bg-primary text-center text-white"><h3>Data Menu  </h3></div>
        <div class="card-body">
        <?php 
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong"><i class="fa fa-plus-circle"></i> Tambah Menu</button><br/><br/>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../controller/Data_crm.php?action=tambah_service" method="POST" enctype="multipart/form-data">
                                ...
                                <label class="my-4">Harga Menu</label>
                                <input type="text" name="harga_service" placeholder="Harga Menu..." class="form-control" required><br>
                        </div>
