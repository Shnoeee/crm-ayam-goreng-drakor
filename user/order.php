...
<div class="col-md-12 mt-5">
    <div class="card-header bg-primary text-center text-white"><h3>Menu</h3></div>
    <div class="card">
        <div class="card-body">
            <?php 
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title">Order Menu</h6>
        ...
        <div class="modal-body">
            <form action="../controller/Data_crm.php?action=tambah_order&id=<?= $row->id_service ?>" method="POST" enctype="multipart/form-data">
                <label class="my-4 h6">Nama Menu</label>
                <p><?= $row->nama_service ?></p>
                <label class="my-4 h6">Deskripsi Menu</label>
                <p><?= $row->deskripsi_service ?></p> 
                <label class="my-4 h6">Harga</label>
