                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-header bg-primary text-white"><h3><?= $data['nama_promo']; ?></h3></div>
                                <div class="card-body">
                                    ...
                                    <a data-toggle="modal" data-target="#exampleModalLongy<?= $data['id_promo'] ?>" href="#" class="btn btn-primary text-center"><i class="fa fa-like"></i> Tertarik</a>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-header bg-primary text-white"><h3><?= $data['nama_produk']; ?></h3></div>
                                <div class="card-body">
                                    ...
                                    <a data-toggle="modal" data-target="#exampleModalLongx<?= $data['id_produk'] ?>" href="#" class="btn btn-primary text-center"><i class="fa fa-like"></i> Tertarik</a>
                                </div>
                                <div class="card-footer bg-primary">
